package com.socketmill.thisismohit.propotions.widget;

/**
 * Created by thisismohit on 01/12/15.
 */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mMovie != null) {
           ...
           // mMeasuredMovieHeight = (int) (movieHeight * mScale);
             mMeasuredMovieWidth = (int) (movieWidth );
             mMeasuredMovieHeight = (int) (movieHeight );
